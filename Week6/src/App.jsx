                    ...
                    <div className="relative flex inset-e-0 bottom-6 group">
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-sm text-gray-700 dark:text-gray-400">
                                Showing <span className="font-semibold text-gray-900">{page+1}</span> to <span className="font-semibold text-gray-900">{limit}</span> of <span className="font-semibold text-gray-900">{ total }</span> Entries
                            </span>
