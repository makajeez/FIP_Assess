        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <form className="p-4 md:p-5" onSubmit={handleSubmit}>
            <div className="grid gap-4 mb-4">
              ...
              <div>
                <label htmlFor="addText" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                  Post Text
                </label>
                <textarea
                  id="addText"
            ...
            >
              <span className="material-symbols-outlined text-base me-2">add</span>
              Add Post
            </button>
          </form>
